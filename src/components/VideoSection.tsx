  ...
  return (
    <section className="py-16 bg-essence-cream">
      <div className="container mx-auto px-6">
        <h2 className="text-3xl md:text-4xl font-bold text-essence-black mb-6 text-center">{title}</h2>
          ...
          <div className="video-container shadow-lg">
            {placeholder ? (
              <div className="absolute inset-0 flex flex-col items-center justify-center bg-essence-black/10">
                ...
                <p className="mt-4 text-essence-black font-medium">Video Preview</p>
              </div>
            ) : (
              <iframe 
                src={videoUrl} 
