...
const SEOMetadata = ({
  ...
  const defaultDescription =
    "EssenceFameFace is a community agency helping models and content creators secure brand deals and monetize their content. Join our expert team to create quality ad videos for brands.";
